...
def populateBoard(chessBoard):
    ...
    addPiece("p", chessBoard, coordinates)
    ...
    addPiece("b", chessBoard, coordinates)
    ...
    addPiece("r", chessBoard, coordinates)
    ...
    addPiece("n", chessBoard, coordinates)
    ...
    addPiece("q", chessBoard, coordinates)
    ...
    addPiece("k", chessBoard, coordinates)
